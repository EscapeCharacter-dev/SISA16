...
VAR#echo_looptop#@
	...
	sc %echo_loopend%;
		...
		ld_current_char;	lb 126;cmp;lb 2;cmp;jmpifeq;

	sc %after_newline_processing%;
	//Do not process characters greater than the 0xd character or less than the 0xa character.
		ld_current_char;	lb 0xd;cmp;lb 2;cmp;jmpifeq;
		ld_current_char;	lb 0xa;cmp;lb 0;cmp;jmpifeq;
