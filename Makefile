...
ifdef MSYS2_BUILD
MORECFLAGS  =  -DUSE_UNSIGNED_INT -DATTRIB_NOINLINE -DUSE_AV -lSDL2 -std=c99  -mwindows -DUSE_TERMIOS -DUSE_COMPUTED_GOTO -DNO_INSN_WEIGHTS
STATIC =  #-static
INSTALL_DIR     = /usr/bin
...
MORECFLAGS  =  -DUSE_UNSIGNED_INT -DATTRIB_NOINLINE -DUSE_TERMIOS -DUSE_COMPUTED_GOTO -DNO_INSN_WEIGHTS
STATIC =  #-static
INSTALL_DIR     = /usr/bin
